export default function NewsLetter() {
  return (
    <div className="flex flex-col items-center justify-center gap-2 py-10 rounded-lg shadow-md">
      <h3 className="text-lg md:text-xl mb-7 font-semibold">SUBSCRIBE TO OUR NEWSLETTER</h3>
